    ...
    <>
      ...
      <div className="matchup">
        <div className="matchup__player">
          <img loading="lazy" className={`${playerOne.imgSrc.indexOf("question2") !== -1 && "question-img-spotlight head-img"}`} src={playerOne.imgSrc} alt={playerOne.name} />
        ...
        <div className="matchup__player">
          <img loading="lazy" className={`${playerTwo.imgSrc.indexOf("question2") !== -1 && "question-img-spotlight head-img"}`} src={playerTwo.imgSrc} alt={playerTwo.name} />
